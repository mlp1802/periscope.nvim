...
local function setup_user_commands()
	...
	vim.api.nvim_create_user_command('PeriscopeShowFiles', function()
		run(function()
			pickers().show_files_for_current_task(false)
		end)
	end, {})
	vim.api.nvim_create_user_command('PeriscopeShowFilesFullPath', function()
		run(function()
			pickers().show_files_for_current_task(true)
		end)
	end, {})
	...
	vim.api.nvim_create_user_command('PeriscopeGrepInTaskFiles', function()
		run(function()
			pickers().grep_in_task_files()
		end)
	end, {})
